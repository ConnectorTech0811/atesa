                  ...
                  <div className="secao-painel-conteudo">
                    ...
                    {secaoAtiva === 1 && (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                        ...
                        <div className="secao-grid-responsive" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 }}>
                          ...
                          <div>
                            <label style={labelStyle}>PIS / NIT</label>
                            <input
                              style={inputStyle}
                              maxLength={14}
                              ...
                              onChange={e => {
                                const formatado = formatarPIS(e.target.value);
                                setDs(p => ({ ...p, pis_pasep: formatado, nit: formatado }));
                              }}
                            />
                          </div>
                          <div>
                    ...
                    {secaoAtiva === 3 && (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                        ...
                        {/* Card Informativo sobre Bancos Parceiros e Taxas */}
                        <div style={{ background: '#f8fafc', border: '1.5px solid #cbd5e1', borderRadius: 10, padding: 16 }}>
                          <div style={{ fontSize: 13.5, fontWeight: 800, color: '#1e293b', display: 'flex', alignItems: 'center', gap: 6, marginBottom: 6 }}>
                        ...
                        <div className="secao-grid-responsive" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 }}>
                          <div>
                            ...
                            <BancoSelect
                              value={db.banco || ''}
                              onChange={(nome, cod) => setDb(p => ({ ...p, banco: nome, codigo_banco: cod || p.codigo_banco }))}
